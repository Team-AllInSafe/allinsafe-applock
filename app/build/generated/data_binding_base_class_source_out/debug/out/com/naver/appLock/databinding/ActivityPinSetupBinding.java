...
public final class ActivityPinSetupBinding implements ViewBinding {
  ...
  private ActivityPinSetupBinding(@NonNull LinearLayout rootView, @NonNull Button btnSetPin,
  ...
  public static ActivityPinSetupBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityPinSetupBinding((LinearLayout) rootView, btnSetPin, etConfirmPin, etPin);
    }
